...
* [install-vscode.bat](scripts/install-vscode.bat)
* [install_codeblocks.bat](scripts/install_codeblocks.bat)
* [install_sqlite3.bat](scripts/install_sqlite3.bat)
* [firewall-config.bat](scripts/firewall-config.bat)
